...
from levelupapi.models import Game, Event, Gamer, EventAttendance
...
class Events(ViewSet):
    ...
    def list(self, request):
        ...
        for event in events:
            ...
            try:
                EventAttendance.objects.get(event=event, gamer=gamer)
                event.joined = True
    ...
    def signup(self, request, pk=None):
        ...
        if request.method == "POST":
            ...
            try:
                ...
                registration = EventAttendance.objects.get(
...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'game', 'organizer',
                  'description', 'event_date', 'time', 'joined')

class GameSerializer(serializers.ModelSerializer):
    """JSON serializer for games"""
    class Meta:
        model = Game
        fields = ('id', 'name', 'maker', 'num_of_players', 'skill_level')
